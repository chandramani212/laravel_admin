...
@section('content')
	<input type='hidden' name="controller_url_path" id="controller_url_path" value="{{ url('city/general') }}" />
		...
		<div class="col-md-12 col-sm-12">
			...
			<div class="portlet light">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-shopping-cart"></i>City Listing
					</div>
					<div class="actions">
						<a href="{{ route('city.create') }}" class="btn default yellow-stripe">
				...
				<div class="portlet-body">
					<div class="table-container">
						...
						<tr role="row" class="filter">
							...
							<td>
								<input type="text" class="form-control form-filter input-sm" name="city_id" id="city_id">
							</td>
							<td>
								<input type="text" class="form-control form-filter input-sm" name="city_name" id="city_name">
							</td>
							<td>
...
<script src="{{ URL::asset('assets/admin/pages/scripts/city-table-ajax.js') }}"></script>
