...
@section('content')
	<input type='hidden' name="controller_url_path" id="controller_url_path" value="{{ url('paymentReceipt/general') }}" />
		...
		<div class="col-md-12 col-sm-12">
			...
			<div class="portlet light">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-shopping-cart"></i>Payment Receipt Listing
					</div>
					<div class="actions">
						<a href="{{ route('paymentReceipt.create') }}" class="btn default yellow-stripe">
						<i class="fa fa-plus"></i>
						<span class="hidden-480">
						Create Payment Receipt </span>
						</a>
						<!--
						<div class="btn-group">
				...
				<div class="portlet-body">
					<div class="table-container">
						...
						<tr role="row" class="filter">
							...
							<td>
								<input type="text" class="form-control form-filter input-sm" name="receipt_id" id="receipt_id">
							</td>
							<td>
								<input class="customer_id form-filter input-sm" id="customer_id" name="customer_id" type="hidden" class="form-control">
							</td>
							<td>
								<input type="text" class="form-control form-filter input-sm" name="amount" id="amount">
							</td>
...
<script src="{{ URL::asset('assets/admin/pages/scripts/payment-receipt-table-ajax.js') }}"></script>
