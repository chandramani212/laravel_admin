		...
		<div class="col-md-12">
			...
			<div class="portlet light">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-shopping-cart"></i>Payment Receipt<span class="hidden-480">
						| #{{ $paymentReceipt->id }}</span>
					</div>
					<div class="actions">
						<a href="{{ route('paymentReceipt.index') }}" class="btn default yellow-stripe">
					...
					<div class="tabbable">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab_1">
								...
								<div class="row">
									@if(isset($paymentReceipt->amount))
									<div class="col-md-6 col-sm-12">
										<div class="portlet blue-hoki box">
											<div class="portlet-title">
												<div class="caption">
													<i class="fa fa-cogs"></i>Payment Receipt
												</div>
												<div class="actions">
												<!--	<a href="javascript:;" class="btn btn-default btn-sm">
													<i class="fa fa-pencil"></i> Edit </a>
											...
											<div class="portlet-body">
												...
												<div class="row static-info">
													...
													<div class="col-md-7 value">
														 {{$paymentReceipt->payment_mode_no}}
													</div>
												</div>
