			...
			<div class="tab-content">
				<div class="portlet box green">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-gift"></i>Edit Payment Receipt
						</div>
						<div class="tools">
					...
					<div class="portlet-body form">
					    ...
					    @endif
						<!-- BEGIN FORM-->
						{!! Form::model($paymentReceipt, ['method' => 'PATCH','route' => ['paymentReceipt.update',$paymentReceipt->id],'class' =>'form-horizontal']) !!}
							@include('pages.paymentReceipt.formEdit')
						{!! Form::close() !!}
						<!-- END FORM-->
					</div>
				</div>
