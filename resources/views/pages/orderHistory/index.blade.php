...
@section('content')
	<input type='hidden' name="controller_url_path" id="controller_url_path" value="{{ url('orderHistory/general') }}" />
...
<script src="{{ URL::asset('assets/admin/pages/scripts/order-table-ajax.js') }}"></script>
