		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<div class="col-md-9">
   						{!! Form::select('customer_id', $customerOption, 'S', array('Placeholder' => 'choose User' ,'id' => 'customer_select' ,'class' => 'select2_category form-control', 'tabindex'=> '1')) !!}					
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<div class="col-md-9" id="customer_address">
   						{!! Form::select('address_id', array(''=>'Choose Address'), 'S', array('id'=>'address_id','Placeholder' => 'choose Address' ,'class' => 'select2_category form-control', 'tabindex'=> '1')) !!}		
						<span class="help-block">
						 </span>
					</div>
				</div>
				...
				<div class="well">
					<div class="row static-info align-reverse">
						...
						<div class="col-md-3 value">
							 ...
							 <input class="form-control" type="text" id="sub_total" name="sub_total" value="0.00" readonly="true" />
					...
					<div class="row static-info align-reverse">
						...
						<div class="col-md-3 value">
							<input class="form-control" type="text" id="grand_total" name="grand_total" value="0.00" readonly="true" />
						</div>
					</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button id="add_product_cart" onclick="add_product_to_cart()" class="btn green btn-primary" data-dismiss="modal" disabled="disabled">Save changes</button>
				</div>
			</div>
		</div>
	</div>
