...
@section('content')
	<input type='hidden' name="controller_url_path" id="controller_url_path" value="{{ url('customerPrice/general') }}" />
		...
		<div class="col-md-12 col-sm-12">
			...
			<div class="portlet light">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="{{ route('customerPrice.create') }}" class="btn default yellow-stripe">
...
<script src="{{ URL::asset('assets/admin/pages/scripts/customer-price-table-ajax.js') }}"></script>
