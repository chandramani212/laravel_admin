...
<link href="{{ URL::asset('asset/global/plugins/font-awesome/css/font-awesome.min.css') }}"rel="stylesheet" type="text/css"/>
   ...
   <form class="form-horizontal" role="form" method="POST" action="{{ url('/login') }}">
        ...
        <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
            ...
            <div class="input-icon">
              ...
              <input id="email" type="email" class="form-control placeholder-no-fix" placeholder="E-mail" name="email" value="{{ old('email') }}">
               @if ($errors->has('email'))
        ...
        <div class="form-group">
            <div class="input-icon">
                <i class="fa fa-envelope"></i>
                 <input id="email" type="email" class="form-control placeholder-no-fix" name="email" value="{{ old('email') }}">
    ...
    <form class="register-form" role="form" method="POST" action="{{ url('/register') }}">
        ...
        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
            ...
            <div class="input-icon">
                ...
                <input id="name" type="text" class="form-control placeholder-no-fix" name="name" value="{{ old('name') }}">
                 @if ($errors->has('name'))
                    <span class="help-block">
    ...
    <!--    <div class="form-group">
       ...
       <!-- <p>
        ...
        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
            ...
            <div class="input-icon">
                <i class="fa fa-lock"></i>
               <input id="password" type="password" class="form-control placeholder-no-fix" name="password">
        ...
        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
            ...
            <div class="controls">
                <div class="input-icon">
                    <i class="fa fa-check"></i>
                     <input id="password-confirm" type="password" class="form-control placeholder-no-fix" name="password_confirmation">
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
     2017 &copy; Agro7 - Admin Dashboard Template.
</div>
<!-- END COPYRIGHT -->
