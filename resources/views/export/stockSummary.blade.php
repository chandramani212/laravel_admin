...
@section('title', 'Export Stock Summary')
@section('subTitle', 'Export stock summary based on date');
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue-hoki">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Export Stock Summary {{ session('status') }}
							</div>
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form method="POST" action="{{ url('stock/general/excel') }}"" class="form-horizontal form-bordered">
							{{ csrf_field() }}
								<div class="form-body">
									<div class="form-group">
										<label class="control-label col-md-3">Date </label>
										<div class="col-md-3">
											<input class="form-control form-control-inline input-medium date-picker" size="16" type="text" value="" name="start_date" id="start_date"  required="true" data-date-format="yyyy-mm-dd" />
